      ...
      <table class="table table-condensed table-striped">
        <thead>
          <tr>
            ...
            <th><?php echo $this->text('Page Load Time (ms)'); ?></th>
            <th><?php echo $this->text('Server Connection Time (ms)'); ?></th>
            <th><?php echo $this->text('Server Response Time (ms)'); ?></th>
          </tr>
        </thead>
        <tbody>
          <?php foreach ($content['data']['report']['data']['rows'] as $row) { ?>
          <tr>
            <td><?php echo $this->truncate($this->e($row['ga:fullReferrer']), 100); ?></td>
            <td><?php echo $this->e($row['ga:pageLoadTime']); ?></td>
            <td><?php echo $this->e($row['ga:serverConnectionTime']); ?></td>
            <td><?php echo $this->e($row['ga:serverResponseTime']); ?></td>
          </tr>
          <?php } ?>
        </tbody>
      </table>
