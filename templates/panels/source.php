    ...
    <?php } else { ?>
      <table class="table table-condensed table-striped">
        ...
        <tbody>
          ...
          <tr>
            <td><?php echo $this->truncate($this->e($row['ga:source']), 100); ?></td>
            <td><?php echo $this->truncate($this->e($row['ga:medium']), 100); ?></td>
            <td><?php echo $this->truncate($this->e($row['ga:campaign']), 100); ?></td>
