...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
  ...
  <fieldset>
    <legend><?php echo $this->text('API credentials'); ?></legend>
  ...
  <fieldset>
    <legend><?php echo $this->text('Results'); ?></legend>
    ...
    <div class="form-group<?php echo $this->error('start_date', ' has-error'); ?>">
      ...
      <div class="col-md-4">
        ...
        <div class="help-block">
          ...
          <div class="text-muted">
            <?php echo $this->text('<a target="_blank" href="@url">Relative</a> to the current date, e.g @example', array('@url' => 'http://php.net/manual/en/datetime.formats.relative.php', '@example' => '-1 month')); ?>
          </div>
        </div>
      </div>
    </div>
    <div class="form-group<?php echo $this->error('end_date', ' has-error'); ?>">
      ...
      <div class="col-md-4">
        ...
        <div class="help-block">
          ...
          <div class="text-muted">
            <?php echo $this->text('<a target="_blank" href="@url">Relative</a> to the current date, e.g @example', array('@url' => 'http://php.net/manual/en/datetime.formats.relative.php', '@example' => 'now')); ?>
          </div>
        </div>
      </div>
    </div>
  ...
  <fieldset>
    <legend><?php echo $this->text('Cache'); ?></legend>
  ...
  <fieldset>
    <legend><?php echo $this->text('View'); ?></legend>
    <div class="form-group">
  ...
  <fieldset>
    <legend><?php echo $this->text('Google Analytics profiles'); ?></legend>
      <?php foreach ($stores as $id => $store) { ?>
      <div class="form-group">
